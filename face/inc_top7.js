...
function loadReports(reportType, reportURL, email, lang, action, level, onlyFavourites) {
  loadAjaxToDiv(level + '/includes/ajax_report.jsp?report_type=' + reportType + '&reportURL=' + reportURL + '&email=' + email + '&action=' + action + '&lang=' + lang + '&level=' + level, "report-confirm");
}
