...
function setBranchForIntrauser(idIntrauser, idMandant, level) {
    loadAjaxToDiv(level + "/includes/ajax_intrauser_branches.jsp?intrauser_id=" + idIntrauser + "&level=" + level + "&mandant_id=" + idMandant + "&action=setBranch", "chooseIntrauserBranch-confirm");
    $( "#chooseIntrauserBranch-confirm" ).dialog( "close" );
